        ...
        <ul>
            ...
            @php
                $canViewComunes = auth()->user()->hasRole('administrador', 'profesor proyecto', 'COORDINADOR_Coordinación_TEMP_PLACEHOLDER', 'coordinador') || 
                                  (auth()->user()->hasRole('estudiante') && auth()->user()->comunidades()->exists());
            @endphp
            ...
            <li>
                ...
                <div class="legacy-submenu">
                    ...
                    @php
                        $canRegisterProject = auth()->user()->hasRole('administrador') || 
                                             (auth()->user()->hasRole('estudiante') && auth()->user()->comunidades()->wherePivot('role_id', 1)->exists());
                    @endphp
            ...
            <li>
                ...
                <div class="legacy-submenu">
                    ...
                    @if(auth()->user()->hasRole('administrador'))
                        ...
                        <a href="{{ route('usuarios.index') }}" class="{{ request()->routeIs('usuarios.index') ? 'active-sub' : '' }}">Usuarios</a>
